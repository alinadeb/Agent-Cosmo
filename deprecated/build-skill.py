...
DESCRIPTION_ONE_LINE = (
    ...
    "On activation the first step is the startup Figma-library handshake — ask the user for a Figma "
    "library URL before planning."
)
...
def main() -> int:
    ...
    reference_map = {
        ...
        "G": ("components.md", "SFE component reference (inline fallback)"),
    }
