---
name: design-to-react-handoff
description: Converts finalized, audit-clean Figma frames into React/TypeScript that follows Trust360UX conventions (per-component folder, tokens, i18n, logger, alias imports, Text components, useCallback/useMemo).
triggers:
  - "generate code"
  - "figma to react"
  - "handoff to code"
  - "code the design"
when-to-use: "Phase 4 of Cosmo. Call this only after Phase 3 audit is clean (or fixes approved) and the Figma design is stable."
---
