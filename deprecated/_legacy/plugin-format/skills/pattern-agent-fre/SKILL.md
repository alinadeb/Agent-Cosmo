---
name: pattern-agent-fre
description: Pattern skill — User wants a first-run modal carousel for agent onboarding and responsible-use education — 2-slide baseline or optional 3-slide variant. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "agent FRE"
  - "first-run experience"
  - "agent onboarding carousel"
  - "what's an agent modal"
