---
name: pattern-copilot-inline-output-card
description: Pattern skill — User wants an inline Copilot output card with generate, loading, and summarized states, including references, feedback, and follow-up actions. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot inline output card"
  - "inline summary card"
  - "copilot summary card"
  - "InlineOutputCard"
  - "generate loading summary card"
  - "references and feedback card"
  - "output card states"
