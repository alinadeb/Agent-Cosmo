---
name: pattern-agent-setup
description: Pattern skill — User wants a multi-step or single-step agent configuration experience — wizard flow, short setup, entry point, and confirmation screen. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "agent setup wizard"
