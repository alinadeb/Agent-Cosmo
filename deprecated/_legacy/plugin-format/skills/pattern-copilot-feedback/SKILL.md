---
name: pattern-copilot-feedback
description: Pattern skill — User wants a modular Copilot feedback experience — inline reactions, popover or sidecar reason capture, toast acknowledgment. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot feedback"
  - "feedback buttons"
