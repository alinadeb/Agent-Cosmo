---
name: pattern-copilot-entry-points
description: Pattern skill — User wants a full graduated Copilot entry-point experience spanning global, page-level, and component-level affordances. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot entry points pattern"
  - "global Copilot entry"
  - "component-level Copilot button"
  - "supplementary Copilot actions"
  - "Copilot overflow menu"
  - "graduated Copilot affordances"
