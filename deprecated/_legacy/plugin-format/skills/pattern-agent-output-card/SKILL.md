---
name: pattern-agent-output-card
description: Pattern skill — User wants an inline AI output card — preview, in-progress, loaded, dismissed, and error states. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "agent output card"
  - "inline output card"
  - "AI action card"
