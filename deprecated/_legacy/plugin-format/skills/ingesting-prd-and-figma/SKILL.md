---
name: ingesting-prd-and-figma
description: Parses prompt / PRD file / existing Figma file into a structured spec Cosmo can build from. Handles the three intake modes and the questions to ask when input is thin.
triggers:
  - "ingest prd"
  - "read figma"
  - "parse requirements"
  - "extract spec"
when-to-use: "Phase 1 of Cosmo. Call this once at the start of any design-to-code workflow to turn raw inputs into a spec."
---
