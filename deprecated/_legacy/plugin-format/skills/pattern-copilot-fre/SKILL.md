---
name: pattern-copilot-fre
description: Pattern skill — User wants a blocking Copilot first-run experience dialog — full-window SFE/Fluent variant, or Azure sidecar variant with an extra step. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "Copilot FRE"
  - "copilot first run experience"
  - "blocking copilot walkthrough"
  - "sidecar FRE"
