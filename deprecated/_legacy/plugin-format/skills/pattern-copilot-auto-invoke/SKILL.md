---
name: pattern-copilot-auto-invoke
description: Pattern skill — User wants a consent-first Copilot auto-invocation workflow — manual baseline, discovery nudge, admin controls, setup flow. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot auto invoke"
  - "auto-invocation"
  - "automatic summaries"
  ...
  - "consent-first generation"
  - "admin controls for Copilot generation"
