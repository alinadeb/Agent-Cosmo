---
name: sfe-ux-standards
description: Reference lookup for Microsoft Security UX standards — content design, accessibility (WCAG 2.2 AA), Responsible AI principles, and design language tokens. Auto-loaded into every Cosmo session.
triggers:
  - "sfe standards"
  - "content design"
