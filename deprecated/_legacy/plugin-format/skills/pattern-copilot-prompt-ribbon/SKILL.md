---
name: pattern-copilot-prompt-ribbon
description: Pattern skill — User wants a prompt ribbon that surfaces contextual starter prompts near the top of a surface and passes them to the Copilot sidecar. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "prompt ribbon"
  - "PromptRibbon"
  - "starter prompts bar"
  - "Copilot sidecar handoff"
  - "contextual starter prompts"
  - "overflow prompt chips"
