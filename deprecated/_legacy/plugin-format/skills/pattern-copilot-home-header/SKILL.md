---
name: pattern-copilot-home-header
description: Pattern skill — User wants a Copilot Home Header promotional shell with required backbone (title, description, CTA) and optional illustration or right-side card content. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot home header"
  - "promotional home banner"
  - "home header hero"
