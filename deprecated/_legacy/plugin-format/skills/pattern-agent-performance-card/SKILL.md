---
name: pattern-agent-performance-card
description: Pattern skill — User wants an agent performance card — single or grouped KPIs with drill-in links, trend sparklines, and resilient state handling. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "agent performance card"
  - "performance metrics card"
  - "agent scorecard"
  - "agent card with KPIs"
