---
name: pattern-copilot-handoff
description: Pattern skill — User wants a Copilot handoff flow with redirect explanation, explicit user confirmation, and destination re-orientation. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot handoff"
