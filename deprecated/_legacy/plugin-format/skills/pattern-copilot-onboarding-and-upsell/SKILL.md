---
name: pattern-copilot-onboarding-and-upsell
description: Pattern skill — User wants a distributed Security Copilot onboarding and upsell flow — chat handoff, trial cards, trial details, banner-based activation. Cosmo delegates entirely to this skill when the request matches.
triggers:
  - "copilot onboarding"
  - "copilot trial upsell"
