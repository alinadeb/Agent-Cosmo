---
name: pattern-agent-management
description: Pattern skill — User wants a persistent management settings shell — tabs for users, triggers, permissions, plugins, and additional settings pages. Cosmo delegates entirely to this skill when the request matches.
triggers:
